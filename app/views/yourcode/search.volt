...
{% endif %}
    <tbody>
        <tr>
            ...
            <td width="7%">{{ link_to("yourcode/edit/" ~ miscodigos.id, '<i class="glyphicon glyphicon-edit"></i> Edit', "class": "btn btn-default") }}</td>
            <td width="7%">{{ link_to("yourcode/delete/" ~ miscodigos.id, '<i class="glyphicon glyphicon-remove"></i> Delete', "class": "btn btn-default") }}</td>
        </tr>
    </tbody>
{% if loop.last %}
    <tbody>
